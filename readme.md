...
### Author · Founder · Researcher — Entertainment Systems & Creative AI

*Read this page in [日本語 (Japanese)](/ja/).*
...
- **1996** — B.Eng. in Photographic Engineering, Tokyo Polytechnic University
- **1998** — M.Eng. in Image Engineering, Tokyo Polytechnic University
- **2003** — Ph.D. in Engineering, Tokyo Institute of Technology (Department of Intelligence Science and Technology)

**Professional experience**

- **1998–2001** — Canon Inc. / Criterion Software (UK) — game-engine development consultant (RenderWare)
- **2003–2004** — NHK Engineering Services, Next-Generation Content Research Lab — Researcher
- **2004–2007** — École Nationale Supérieure d'Arts et Métiers (ENSAM), France — Visiting Researcher
- **2006–** — Laval Virtual "ReVolution" — Session Organizer
- **2007–2010** — National Museum of Emerging Science and Innovation (Miraikan) — Science Communicator
- **2010–2018** — Kanagawa Institute of Technology — Associate Professor
- **2018–2023** — GREE, Inc. — Director, GREE VR Studio Laboratory (seconded to REALITY, Inc.)
...
- **2026** — Selected for the **Supercell AI Innovation Lab** (Helsinki & Tokyo) — a highly selective program run by the game company [Supercell](https://supercell.com/)
- Winner, the 1st **AIBATO** Generative-AI Art Battle
- **Hello Tomorrow** Global Summit — Top 500 Startups ("Multiplex World Augmentation Display")
- **2012** — ACM SIGGRAPH Asia Emerging Technologies Prize (*Scritter*)
- **2012** — CEDEC Awards, Interactive Session Grand Prize (*Scritter*)
- **2013** — Innovative Technologies, awarded by Japan's METI — *2x3D*, a backward-compatible 2D/3D multiplex display
- **2015** — Laval Virtual Award (*ExPixel FPGA*)
- **2015** — NicoNico Gakkai β Symposium — Gold Prize by audience vote
- **2016** — CEDEC Interactive Session, Audience Award, 2nd place (*DUAL DUEL*)
- **2022** — Best Short Paper, CyberWorlds 2022 (co-author)
- **2023** — [AI-Assisted Avatar Fashion Show](https://doi.org/10.1145/3588028.3603660), ACM SIGGRAPH 2023 Posters

## Affiliations

- Virtual Reality Society of Japan — organizing committee, [IVRC](https://ivrc.net/) international student VR contest
- [Society for Art and Science](https://art-science.org/) — Vice President (2022–2024)
