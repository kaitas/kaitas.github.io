...
## G201TG2041	白瑞（ハクズイ）さんからのフィードバック

日本語：「丁寧」「叮嚀」，中国語：「丁宁（丁寧）」「叮咛（叮嚀）」／
日本語「丁寧」の説明は、「昔の中国の軍隊では「丁寧」と呼ばれる周りに注意を促す警報として使用されていました。」と書いている。これは確かに中国人として知らない知識だ。その後、インターネットで「丁宁」に関する情報を少し検索しました。この中国語の語彙は最初に紀元前に現れました。／　　「丁宁」の意味は：
１　当時ある楽器の名前だ。　２　楽器の音を表現するのにも使えます。　３　繰り返し言い聞かせる　４　言葉遣いがていねいである　　５　メッセージ／
以上の用法はたぶん古代の文献にしか存在しない。　　現代中国語の中で、この単語の一番よく使われている意味は「くれぐれも言い聞かせる.繰り返し言う」と近いです。／
今使っている現代中国語の中で。「丁宁」はあまり使われていません。「叮咛」のほうが使われています。この二つの言葉の意味は同じです。／　　日本語は逆だ。「叮嚀」より「丁寧」の方がよく使われています。／
この言葉、現代中国語より日本語のほうがよく使われています。現代中国語では、他の言葉を使って同じ意味を表現することが多い。。。
私が言ったところには正確ではないところがあるかもしれません。もし他の人を助けることができれば幸いです。／

私のvtuber企画案に対するご意見ありがとうございます。