...
author: aki
description: 主著者として、共著者として、指導者として、そしてあるいは査読者として。論文を査読者視点で完成させる、というメソッドをまとめる機会がありましたので書き綴っておきます。
...
### (余談)査読者は「怖い存在」なのか
<details><summary>(click to extend)</summary><div>
...
締め切りと戦う日々の中で、
査読者視点で読む、つまり「今まで書き上げてきた論文を叩き切るような行為」はなかなか難しいです。
